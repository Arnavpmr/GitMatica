...
public final class LvcProjectSelectionStorage
{
    ...
    public static List<LvcManifest.Region> createRegionsFromSelection(AreaSelection selection, BlockPos origin)
    {
        Objects.requireNonNull(selection, "selection");
        ...
        for (Box box : boxes)
        {
            ...
            {
                throw new IllegalArgumentException("LVC sub-region names must be unique: " + regionName);
            }
