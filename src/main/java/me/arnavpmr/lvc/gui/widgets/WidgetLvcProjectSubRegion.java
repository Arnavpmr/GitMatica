...
public class WidgetLvcProjectSubRegion extends WidgetListEntryBase<LvcManifest.Region>
{
    ...
    {
        selected = this.entry != null && this.entry.name().equals(this.parent.getEditorGui().getSelectedRegionName());
    ...
    private record ButtonListener(ButtonType type, WidgetLvcProjectSubRegion widget)
