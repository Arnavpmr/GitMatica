...
/**
 * Exact project-relative coverage that existed in one site definition but is
 * not covered by any sub-region in the updated definition.
 */
public final class LvcRetiredCoveragePlan
{
    ...
    private static List<Cuboid> mergeAlongAxis(List<Cuboid> cuboids, Axis axis)
    {
        ...
        {
            group.sort(Comparator.comparingInt(axis::min));
            Cuboid current = group.getFirst();
